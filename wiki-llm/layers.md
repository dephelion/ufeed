...
| :--- | :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------- | :-------------------- |
| 1    | `core/`        | uFeed's rules: model constants, scoring, the blur policy, settings and ratings shapes, language and media rules, the engine message contract, status text, message keys, the `Translate` type, the popup's language list, backup format, caches, logging | `core/`                      | Plain JavaScript only |
