...
| 3    | `platform/`    | Extension APIs and libraries: storage, runtime messaging, the engine client (iframe or shared offscreen port), the embedder (transformers.js)                                                                                                                               | `core/`, `feed/`, own folder | Anything              |
