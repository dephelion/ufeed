...
- Allowlist filter. User names topics to keep; everything else blurs. An optional blacklist only narrows what the topics let through; never a blocklist-only mode.
