...
| Blacklist                         | Collapsed disclosure under the topics, open once it holds a line. Comma-separated keywords or phrases (`，` and `、` too), wrapped, no bands; saved by the same Apply. |
