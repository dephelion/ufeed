...
- **Confirm Before Deciding:** Confirm design decisions with a cost the user has not weighed — model size, dependency weight, added permissions. Never ask before a `wiki-llm/` edit; Update-On-Change applies.
