...
Lensing blurs posts in your social feed that are not about topics you chose. It
does this on your own device. This policy describes everything it reads, stores
and sends.

## Short version

Lensing does not collect your data. Nothing you read, type or rate is sent to us
...
On x.com, twitter.com, linkedin.com and reddit.com, Lensing reads the text of
...
Lensing does not read any other page. On every other website it does nothing.

## What Lensing stores on your device
...
**About thumb ratings.** When that option is on and you rate a post, Lensing
...
your topics, none of your feed, and no identifier for you or for Lensing. Their
handling of that request is governed by their own privacy policy. This is the
only time Lensing contacts any server.

Lensing sends nothing to us. We operate no server that Lensing talks to.

## Permissions, and why each is needed

| Permission                                             | Why                                                                                         |
| :----------------------------------------------------- | :------------------------------------------------------------------------------------------ |
| Access to x.com, twitter.com, linkedin.com, reddit.com | To read post text in the page and apply the blur. These are the only sites Lensing runs on. |
| `storage`                                              | To keep your settings and, if you turn it on, your thumb ratings on your device.            |

Lensing requests no other permission. It cannot see your browsing history, your
...
Lensing is not directed at children and collects no data from anyone.
