...
FeedLens does not collect your data. Nothing you read, type or rate is sent to us
...
On x.com, twitter.com, linkedin.com and reddit.com, FeedLens reads the text of
...
FeedLens does not read any other page. On every other website it does nothing.

## What FeedLens stores on your device
...
| What          | Details                                                                                             |
| :------------ | :-------------------------------------------------------------------------------------------------- |
| Your settings | Topics, strictness, which model you chose, the popup language, and the on/off toggles in the popup. |
...
| Permission                                             | Why                                                                                          |
| :----------------------------------------------------- | :------------------------------------------------------------------------------------------- |
| Access to x.com, twitter.com, linkedin.com, reddit.com | To read post text in the page and apply the blur. These are the only sites FeedLens runs on. |
| `storage`                                              | To keep your settings and, if you turn it on, your thumb ratings on your device.             |

FeedLens requests no other permission. It cannot see your browsing history, your
...
FeedLens is not directed at children and collects no data from anyone.
